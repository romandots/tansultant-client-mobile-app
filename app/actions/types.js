...
export const FETCH_NEWS_COMMENTS_REJECTED = "FETCH_NEWS_COMMENTS_REJECTED";
export const FETCH_NEWS_COMMENTS_PENDING = "FETCH_NEWS_COMMENTS_PENDING";
export const FETCH_NEWS_COMMENTS_FULFILLED = "FETCH_NEWS_COMMENTS_FULFILLED";
